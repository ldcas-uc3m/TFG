...
The use case model (Figure \ref{fig:use_case_model}) represents the typical usage of the system, allowing developer to visualize the different interactions between the user and the functionalities the system offers. The use case model includes all the different use cases for the system.  % TODO: find reference for UML use case model
