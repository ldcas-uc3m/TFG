...
The aim is to provide the user with a more `logical' approach to understanding \gls{assembly} programming, by abstracting the hardware details and providing a simple and generic architecture.
...
\begin{userReq}{UR-CA-\padtwo{i}}{pc=l,pd=l,s=c,v=h}
...
\begin{userReq}{UR-RE-\padtwo{i}}{pc=m,pd=m,s=c,v=h}
