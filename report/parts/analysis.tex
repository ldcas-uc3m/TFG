...
Starting from the user requirements (\subsecref{user-requirements}), which constitute an informal reference to the product the client expects, we derived the software requirements (\subsecref{soft-requirements}) that guided the design process with specific information on the functionality of the system, as well as any and other related characteristics.
