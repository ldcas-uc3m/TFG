...
% JSON -> diagrama entidad-relación? json schema? https://json-schema.org/draft/2020-12/draft-bhutton-json-schema-01
As stated in Subsection \subsecref{isa-format-study}, the \gls{ISA} will be defined in a \gls{json} format, which will also serve as the configuration file for the simulator. For the configuration, we'll need to define several things:
\begin{itemize}
