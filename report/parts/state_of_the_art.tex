...
This chapter presents the current stage of the technologies related to the application, specifically the different kinds of simulators that are currently present in the market (\secref{assembly-simulators}), both specific to one architecture (\subsecref{specific-assembly-simulators}) and architecture-agnostic simulators (\subsecref{generic-assembly-simulators}).\\
...
In \tabref{sim-comparison}, a comparison of the different features of the current assembly simulators and the proposal is provided.
