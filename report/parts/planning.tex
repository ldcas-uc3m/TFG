...
This chapter presents an overview of the development and logistics of the project. The planning of the project (\secref{planning}) is detailed, analyzing its budget and overall cost (\secref{budget}), and the socio-economic environment in which it was carried out is finally discussed.
...
Equipment costs refer to those caused by equipment acquisition and usage. The chargeable cost, $C$, for each item is calculated using Equation \eqref{eq:chargeable-cost}, where:
\begin{itemize}
...
% This section discusses the environment in which this project takes place: how it currently is, and how this project impacts it.
