...
This chapter presents an overview of the development and logistics of the project. We detail the planning of the project (\secref{planning}), analyze its budget and overall cost (\secref{budget}), and we finally discuss the socio-economic environment in which it was carried out.
