...
\begin{itemize}
  ...
  \item \chapterref{chap:state-of-the-art}, includes a description of the current types of educational \gls{assembly} simulators, and a compares them with our proposal.
