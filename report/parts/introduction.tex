...
\begin{itemize}
  ...
  \item \chapref{analysis}, explains the proposed solution and establishes its requirements and use cases.
  ...
  \item \chapref{validation}, details the verification and validation of the system and its objectives, including test cases.
  \item \chapref{planning}, presents the concepts related to the followed planning, breaks down all project costs. It also discusses the regulatory framework and socio-economic environment that applies to the project.
  \item \chapref{conclusions}, highlights the contributions of the project, explains our overall conclusions, and presents what future work could be done in order to improve it.
