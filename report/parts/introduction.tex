...
\begin{itemize}
  ...
  \item \chapref{planning}, presents the concepts related to the followed planning, breaks down all project costs, and describes the socio-economic environment.
  \item \chapref{regulation}, discusses the set of laws and regulations that apply to the project.
